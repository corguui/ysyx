...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+151,"inv_flag", false,-1);
    ...
    tracep->declBus(c+152,"snpc", false,-1, 31,0);
    ...
    tracep->declQuad(c+156,"default_out", false,-1, 32,0);
    tracep->declArray(c+92,"lut", false,-1, 399,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+153,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+154,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+155,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+158,"HAS_DEFAULT", false,-1, 31,0);
    tracep->declQuad(c+90,"out", false,-1, 32,0);
    tracep->declBus(c+55,"key", false,-1, 6,0);
    tracep->declQuad(c+156,"default_out", false,-1, 32,0);
    tracep->declArray(c+92,"lut", false,-1, 399,0);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+151,(vlSelf->inv_flag));
    bufp->fullIData(oldp+152,(((IData)(4U) + vlSelf->pc)),32);
    bufp->fullIData(oldp+153,(0xaU),32);
    bufp->fullIData(oldp+154,(7U),32);
    bufp->fullIData(oldp+155,(0x21U),32);
    bufp->fullQData(oldp+156,(1ULL),33);
    bufp->fullIData(oldp+158,(1U),32);
    bufp->fullIData(oldp+159,(0x28U),32);
    bufp->fullIData(oldp+160,(0xaU),32);
