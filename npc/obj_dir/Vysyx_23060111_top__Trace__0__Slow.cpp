...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+116,"m_waddr", false,-1, 31,0);
    tracep->declBus(c+117,"m_wdata", false,-1, 31,0);
    tracep->declBus(c+118,"m_wmask", false,-1, 31,0);
    tracep->declBus(c+127,"m_rdata", false,-1, 31,0);
    tracep->declBus(c+128,"m_raddr", false,-1, 31,0);
    tracep->declBit(c+119,"m_wen", false,-1);
    tracep->declBit(c+120,"m_ren", false,-1);
    ...
    tracep->declBus(c+118,"wmask", false,-1, 31,0);
...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_full_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+116,(vlSelf->ysyx_23060111_top__DOT__m_waddr),32);
    bufp->fullIData(oldp+117,(vlSelf->ysyx_23060111_top__DOT__m_wdata),32);
    bufp->fullIData(oldp+118,(vlSelf->ysyx_23060111_top__DOT__m_wmask),32);
    bufp->fullBit(oldp+119,(vlSelf->ysyx_23060111_top__DOT__m_wen));
    bufp->fullBit(oldp+120,(vlSelf->ysyx_23060111_top__DOT__m_ren));
    ...
    bufp->fullBit(oldp+126,(vlSelf->ysyx_23060111_top__DOT__wen));
    bufp->fullIData(oldp+127,(vlSelf->ysyx_23060111_top__DOT__m_rdata),32);
    bufp->fullIData(oldp+128,(vlSelf->ysyx_23060111_top__DOT__m_raddr),32);
