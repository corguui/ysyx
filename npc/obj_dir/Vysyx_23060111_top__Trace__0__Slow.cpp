...
VL_ATTR_COLD void Vysyx_23060111_top___024root__trace_init_sub__TOP__0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+89,"inv_flag", false,-1);
    ...
    tracep->declBus(c+91,"snpc", false,-1, 31,0);
    tracep->declBus(c+92,"opcode", false,-1, 6,0);
    tracep->declBus(c+93,"rd", false,-1, 11,7);
    tracep->declBus(c+94,"funct3", false,-1, 14,12);
    tracep->declBus(c+95,"rs1", false,-1, 19,15);
    tracep->declBus(c+96,"rs2", false,-1, 24,20);
    tracep->declBus(c+97,"funct7", false,-1, 31,25);
    tracep->declBus(c+8,"type_i", false,-1, 3,0);
    tracep->declBus(c+9,"imm", false,-1, 31,0);
    tracep->declBus(c+98,"wdata", false,-1, 31,0);
    tracep->declBus(c+93,"waddr", false,-1, 4,0);
    tracep->declBus(c+95,"raddr", false,-1, 4,0);
    ...
    tracep->declBus(c+92,"key", false,-1, 6,0);
