...
void Vysyx_23060111_top___024root__trace_chg_sub_0(Vysyx_23060111_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        ...
        bufp->chgBit(oldp+115,(vlSelf->ysyx_23060111_top__DOT__wen));
        bufp->chgIData(oldp+116,(vlSelf->ysyx_23060111_top__DOT__m_waddr),32);
        bufp->chgIData(oldp+117,(vlSelf->ysyx_23060111_top__DOT__m_wdata),32);
        bufp->chgIData(oldp+118,(vlSelf->ysyx_23060111_top__DOT__m_wmask),32);
        bufp->chgBit(oldp+119,(vlSelf->ysyx_23060111_top__DOT__m_wen));
    }
    ...
    bufp->chgIData(oldp+125,(vlSelf->ysyx_23060111_top__DOT__m_rdata),32);
    bufp->chgIData(oldp+126,(vlSelf->ysyx_23060111_top__DOT__m_raddr),32);
    bufp->chgBit(oldp+127,(vlSelf->ysyx_23060111_top__DOT__m_ren));
}
